...
const metodologia = [
  {
    ...
    titulo: "Análisis geométrico desde tu modelo Civil 3D",
    descripcion:
  ...
  },
  {
    ...
    titulo: "Velocidad Operacional V85 — Método Lamm (1999)",
    descripcion:
  ...
  {
    badge: "Capacidad única",
    badgeColor: "bg-blue-500/10 border-blue-500/30 text-blue-400",
    titulo: "Auditoría HV — Visibilidad Horizontal y Vertical Simultánea",
    descripcion:
      ...
      <div className="container">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="text-lg leading-relaxed text-body-color">
            No es software estándar. Es una metodología propia que automatiza
            procesos que ningún CAD resuelve — con entregables técnicos
            respaldados por normativa oficial.
          </p>
        </div>
